...
public class PositionIOReal extends PowerIOReal implements PositionSystemIO {
    ...
    private StatusSignal<Double> motionMagiPose;
    private StatusSignal<AngularVelocity> motionMagiVelocity;
    ...
    public PositionIOReal(PositionSystemConstants systemConstants) {
        ...
        motorSetPoint = systemConstants.master.motorController.getClosedLoopReferenceSlope(false);//
        motionMagiPose = systemConstants.master.motorController.getClosedLoopReference(false);
        motionMagiVelocity = systemConstants.master.motorController.getVelocity(false);
    ...
    public double getError() {
        //return motorError.getValueAsDouble() * systemConstants.POSITION_FACTOR * 360;//TODO:Test
        return setPoint - getPosition();
    }

    @Override
    public double getSetPoint() {
        //return motorSetPoint.getValueAsDouble() * systemConstants.POSITION_FACTOR * 360;//TODO:Test
        return setPoint;
    }
